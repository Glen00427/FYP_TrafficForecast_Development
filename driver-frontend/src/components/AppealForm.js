    ...
    >
      ...
      >
        ...
        <form className="gate-form" onSubmit={handleSubmit}>
          <label className="usf-label" htmlFor="appeal-msg">
            Message
          </label>
          <textarea
            id="appeal-msg"
          ...
          <div className="ban-actions">
            <button type="button" className="sm-user-pill is-ghost" 
            onClick={() => setAppealFor(null)}>
              Cancel
            </button>
          
            <button type="button" className="sm-user-pill" 
            disabled={appealSubmitting} onClick={submitIncidentAppeal}>
